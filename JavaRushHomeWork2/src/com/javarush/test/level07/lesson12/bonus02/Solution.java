...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            for (int a = 0; a < z; a++) newList.add(s);
        }

        for (int i = 0; i < newList.size(); i++) {
            if (i == newList.size() - 1) System.out.println(newList.get(i));
            else if (newList.get(i).equals(newList.get(i+1))) System.out.print(newList.get(i) + " ");
            else System.out.println(newList.get(i));
        }
